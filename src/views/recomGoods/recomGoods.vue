<template>
    <div class="recomGoods">
        <el-card class="box-card">
            <div class="text item">
                <div class="headers">
                    <el-button type="success" class="addgg" size="small" @click="add = true">添加推荐商品</el-button>
        ...
        <el-dialog title="添加推荐商品" :visible.sync="add" class="addggs" width="30%">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // api.recomgood.lookRecomgood(this.idd).then(res=>{
            //     if(res.data.code==200){
            //         this.$message({
            //             type:"success",
            //             message:"获取成功"
...
<style scoped>
    ...
    .recomGoods .search-first{
        width: 30%;
        float: right;
        margin-top:9px !important;
    }
    .recomGoods .el-form .el-input{
        width: 100%;
        float: left;
        margin-left:0;
    }
...
<style>
    .recomGoods .el-form-item__label{
        margin-top:10px !important;
    }
    .recomGoods .el-form-item__content{
        width: auto !important;
        float: left;
    }
    .recomGoods .el-form-item__error{
        margin-left:0 !important;
    }
    .recomGoods .btns .el-form-item__content{
        width: auto !important;
        float: right;
        margin-top:20px;
        margin-right:20px;
